...
//Letters 
SDL_Rect letter_a = { 11,60, 9,10 };
SDL_Rect letter_b = { 19,60, 9,10 };
SDL_Rect letter_c = { 27,60, 9,10 };
SDL_Rect letter_d = { 35,60, 9,10 };
SDL_Rect letter_e = { 43,60, 9,10 };
SDL_Rect letter_f = { 51,60, 9,10 };
SDL_Rect letter_g = { 59,60, 9,10 };
SDL_Rect letter_h = { 67,60, 9,10 };
SDL_Rect letter_i = { 75,60, 9,10 };
SDL_Rect letter_j = { 83,60, 9,10 };
SDL_Rect letter_k = { 91,60, 9,10 };
SDL_Rect letter_l = { 99,60, 9,10 };
SDL_Rect letter_m = {107,60, 9,10 };
SDL_Rect letter_n = {115,60, 9,10 };
SDL_Rect letter_o = {123,60, 9,10 };
SDL_Rect letter_p = { 3,68,  9,10 };
SDL_Rect letter_q = { 11,68, 9,10 };
SDL_Rect letter_r = { 19,68, 9,10 };
SDL_Rect letter_s = { 27,68, 9,10 };
SDL_Rect letter_t = { 35,68, 9,10 };
SDL_Rect letter_u = { 43,68, 9,10 };
SDL_Rect letter_v = { 51,68, 9,10 };
SDL_Rect letter_w = { 59,68, 9,10 };
SDL_Rect letter_x = { 67,68, 9,10 };
SDL_Rect letter_y = { 75,68, 9,10 };
SDL_Rect letter_z = { 83,68, 9,10 };
SDL_Rect letter_poi = { 91, 68, 9,10 };
SDL_Rect letter_arr = { 99, 68, 9,10 };
